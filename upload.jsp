...
if(ext == "gif" || ext == "GIF" || ext == "JPEG" || ext == "jpeg" || ext == "jpg" || ext == "JPG" || ext == "txt")
{
return true;
} 
else
...
if(request.getParameter("status")!=null){
	...
	out.println("<script>alert('Attach the File...')</script>");
%>
<!-- wrapper starts -->
<div class="wrapper"> 
...
<div STYLE="">
    ...
    <img src="images/lakshmi.jpg" width="400" height="300" alt="" id="myImgId" /><br>
    <br>
...
<p>Y: <span id="y2"></span></p><br>
    ...
    <form  action="upload"  name="form1" method="post" enctype="multipart/form-data" onsubmit="return Checkfiles();">
            <p><strong>First Point:</strong></p><br>
...
<p>Y: <input type="text" id="y2"  name="yy2"></input></p><br>
  
        <input type="file" name="file" id="filename"></input><br>
